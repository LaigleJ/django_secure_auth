...
load_dotenv(BASE_DIR / ".env")  # charge variables depuis .env
...
# Argon2 comme hasher principal (argon2-cffi doit être installé)
PASSWORD_HASHERS = [
...
# Validation des mots de passe (min 12 caractères comme demandé)
